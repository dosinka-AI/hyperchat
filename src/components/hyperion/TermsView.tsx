...
/** Placeholder: the real terms are not written yet, so the page is just a
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1 grid place-items-center px-4 py-16">
        <div className="text-center select-none">
          <p className="text-sm font-bold tracking-widest text-muted-foreground lowercase">terms</p>
          <p className="mt-3 text-7xl font-extrabold tracking-tight text-muted-foreground/80" aria-label="terms not written yet">
            ?
          </p>
        </div>
      </main>
