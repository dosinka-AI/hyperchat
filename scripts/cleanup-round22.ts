/* Remove the round-22 throwaway account and everything it touched.
 * Never touches blazar / kkkkwwwaaaa / quasar. */
import { PrismaClient } from '@prisma/client'

const db = new PrismaClient()

const names = ['qa22embed']
...
// bookmarks, reminders, scheduled, read states, mutes
...
// conversations they participated in (the quasar DM; cascades participants + messages)
